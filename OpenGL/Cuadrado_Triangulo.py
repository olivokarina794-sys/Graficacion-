...
def display():
    ...
    # Dibujar un triángulo de colores encima del cuadrado (MISMOS COLORES)
...
def main():
    ...
    glutCreateWindow(b"Cuadrado y Triangulo con Colores - GLUT y Python")
