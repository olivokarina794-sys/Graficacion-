...
# ========== PASO 1: ESCALAR x2 CON VECINO MÁS CERCANO ==========
scale_factor = 2
...
# ========== PASO 2: ROTAR 25° CON FILTRO BILINEAL ==========
angle = 25  # CAMBIADO: 25 grados en lugar de 45
theta = math.radians(angle)

# Calcular nuevo tamaño para contener la rotación
...
print("Rotando 25° con filtro bilineal...")  # CAMBIADO: 25 grados
for i in range(rot_x):
    for j in range(rot_y):
        # Coordenadas relativas al centro de la imagen rotada
        rel_x = j - rot_cy
        rel_y = i - rot_cx
        ...
        # Aplicar interpolación bilineal con verificación de límites
...
cv.imshow('3. Imagen Rotada 25° (Bilineal)', rotated_img)  # CAMBIADO: 25°
