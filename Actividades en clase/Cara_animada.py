import cv2 as cv 
import numpy as np
#08/10/25 A la animacion de la ultima clase agregarle movimiento en las pupilas de los ojos y en la boca agregarle 
#un circulo para simular el movimiento de la lengua 
